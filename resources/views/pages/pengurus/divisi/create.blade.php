    ...
    <div class="md:flex md:items-center md:justify-between mb-8">
        <div class="flex-1 min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Buat divisi baru untuk struktur organisasi.
            </p>
        </div>
    ...
    <div class="bg-white shadow-[10px_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden sm:rounded-lg border border-gray-200 max-w-3xl mx-auto">
        <div class="px-4 py-4 sm:px-6 bg-gray-50 border-b border-gray-200">
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                Isi detail divisi dengan lengkap.
            </p>
        </div>
            ...
            <form action="{{ route('pengurus.divisi.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="isi_divisi" name="isi_divisi" rows="8" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('isi_divisi') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror px-3 py-2" placeholder="Jelaskan tugas dan tanggung jawab divisi ini...">{{ old('isi_divisi') }}</textarea>
                        </div>
                        @error('isi_divisi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
