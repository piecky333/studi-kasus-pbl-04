                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-3 py-2 lg:px-6 lg:py-4">
                            <div class="text-xs lg:text-sm font-medium text-gray-900 whitespace-normal">{{ $row->nama_divisi }}</div>
                        </td>
                        <td class="px-3 py-2 lg:px-6 lg:py-4 whitespace-nowrap text-center text-xs lg:text-sm font-medium">
                            <div class="flex justify-center space-x-1 lg:space-x-2">
                                {{-- Edit --}}
                                <a href="{{ route('pengurus.divisi.edit', $row) }}" class="inline-flex items-center px-2 py-1 lg:px-3 lg:py-2 text-xs lg:text-sm font-medium rounded-lg transition-colors duration-200 bg-amber-100 text-amber-600 hover:bg-amber-600 hover:text-white" title="Edit">
