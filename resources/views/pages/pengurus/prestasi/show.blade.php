    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="{{ route('pengurus.dashboard') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('pengurus.prestasi.index') }}" class="text-sm font-medium text-gray-700 hover:text-blue-600">Data Prestasi</a>
                </div>
            </li>
            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100">
                         <a href="#" class="block w-full text-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-gray-400 bg-gray-100 cursor-not-allowed">
                            Profil Lengkap (Hanya Admin)
                         </a>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-2/3">
            <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden h-full">
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-3 border-t border-gray-200">
                    <a href="{{ url()->previous() == url()->current() ? route('pengurus.prestasi.index') : url()->previous() }}" class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Kembali
                    </a>
