            ...
            <form action="{{ route('pengurus.berita.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6" x-data="{ photoName: null, photoPreview: null }">
                        ...
                        <!-- Hidden Input -->
                        <input type="file" name="gambar_berita" class="hidden" x-ref="photo"
                            x-on:change="
                        ...
                        <!-- Dropzone Label -->
                        <label x-show="!photoPreview" x-on:click.prevent="$refs.photo.click()"
                        ...
                        <!-- Preview Container -->
                        <div class="mt-1 relative" x-show="photoPreview" style="display: none;">
                            <img :src="photoPreview" class="w-full h-64 object-cover rounded-md">

                            <!-- Change Button -->
                            <button type="button"
                                class="absolute bottom-2 right-20 bg-white text-gray-700 rounded-md px-3 py-1 text-sm font-medium shadow-sm hover:bg-gray-50 focus:outline-none border border-gray-300"
                            ...
                            <!-- Remove Button -->
                            <button type="button"
                                class="absolute bottom-2 right-2 bg-red-600 text-white rounded-md px-3 py-1 text-sm font-medium shadow-sm hover:bg-red-700 focus:outline-none"
                                x-on:click="photoPreview = null; photoName = null; $refs.photo.value = null">
                                Hapus
                            </button>
                        </div>
