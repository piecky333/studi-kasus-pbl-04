...
<div class="container-fluid px-4 mt-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h4 class="text-2xl font-bold text-gray-800">Edit Mahasiswa</h4>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi data mahasiswa.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nim" name="nim"
                               ...
                               placeholder="Contoh: 2023001" value="{{ old('nim', $mahasiswa->nim) }}" required>
                        @error('nim')
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" name="nama"
                               ...
                               placeholder="Masukkan nama lengkap..." value="{{ old('nama', $mahasiswa->nama) }}" required>
                        @error('nama')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" id="email" name="email"
                               ...
                               placeholder="nama@mahasiswa.ac.id" value="{{ old('email', $mahasiswa->email) }}" required>
                        @error('email')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="number" step="0.01" min="0" max="4.00" name="ipk" id="ipk"
                               class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none @error('ipk') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror"
                               placeholder="Contoh: 3.50" value="{{ old('ipk', $mahasiswa->ipk) }}">
                        @error('ipk')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
