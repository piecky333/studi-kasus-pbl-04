...
<div class="container-fluid px-4 mt-6">
    ...
    <div class="mb-6 bg-white p-5 rounded-lg shadow-sm border border-gray-200">
        <div class="flex items-center mb-4">
            ...
            <h3 class="text-lg font-medium text-gray-900">Filter & Pencarian Sanksi</h3>
        </div>
        <form action="{{ route('admin.sanksi.index') }}" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-2 flex space-x-2">
                    ...
                    <a href="{{ route('admin.sanksi.index') }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Reset
                    </a>
                </div>
            </div>
