    ...
    <div class="md:flex md:items-center md:justify-between mb-8">
        <div class="flex-1 min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Perbarui data sanksi mahasiswa.
            </p>
        </div>
    ...
    <div class="bg-white shadow-[10px_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden sm:rounded-lg border border-gray-200 max-w-3xl mx-auto">
        <div class="px-4 py-4 sm:px-6 bg-gray-50 border-b border-gray-200">
            <h3 class="text-lg leading-6 font-medium text-gray-900">
                Formulir Edit Sanksi
            </h3>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                Perbarui informasi sanksi di bawah ini.
            </p>
        </div>
            ...
            <form action="{{ route('admin.sanksi.update', $sanksi->id_sanksi) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="mt-1">
                            <select id="id_mahasiswa" name="id_mahasiswa" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('id_mahasiswa') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror px-2 py-3" required>
                                ...
                                @foreach($mahasiswa as $mhs)
                                    <option value="{{ $mhs->id_mahasiswa }}" {{ (old('id_mahasiswa', $sanksi->id_mahasiswa) == $mhs->id_mahasiswa) ? 'selected' : '' }}>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="date" name="tanggal_sanksi" id="tanggal_sanksi" value="{{ old('tanggal_sanksi', $sanksi->tanggal_sanksi) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('tanggal_sanksi') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror px-2 py-3">
                        </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="keterangan" name="keterangan" rows="4" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('keterangan') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror px-2 py-3" placeholder="Masukkan keterangan / detail pelanggaran">{{ old('keterangan', $sanksi->keterangan) }}</textarea>
                        </div>
