        ...
        <div class="bg-white shadow-xl rounded-lg p-8">
            ...
            <form action="{{ route('admin.spk.kriteria.store', $keputusan->id_keputusan) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    {{-- Pilihan Dropdown: Menentukan sumber data (Manual atau Otomatis) --}}
                    <div>
                        ...
                        <select name="sumber_data" id="sumber_data" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm
                            ...
                            <option value="Manual" {{ old('sumber_data') == 'Manual' ? 'selected' : '' }}>Manual</option>
                            <option value="Prestasi" {{ old('sumber_data') == 'Prestasi' ? 'selected' : '' }}>Prestasi</option>
                            <option value="Sanksi" {{ old('sumber_data') == 'Sanksi' ? 'selected' : '' }}>Sanksi</option>
                            <option value="Pengaduan" {{ old('sumber_data') == 'Pengaduan' ? 'selected' : '' }}>Pengaduan</option>
                            <option value="Berita" {{ old('sumber_data') == 'Berita' ? 'selected' : '' }}>Berita</option>
                        </select>
                        @error('sumber_data')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div id="nama_kriteria_text_container">
                            <input type="text" name="nama_kriteria" id="nama_kriteria_text" value="{{ old('nama_kriteria') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm
                                       @error('nama_kriteria') border-red-500 @enderror"
                                placeholder="Contoh: Kehadiran, Keaktifan" >
                        </div>
