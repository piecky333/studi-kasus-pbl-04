...
Untuk Kriteria: <span class="font-medium text-blue-600">{{ $kriteria->nama_kriteria }} ({{ $kriteria->kode_kriteria }})</span>
</p>
</header>
    ...
    {{-- Form action menunjuk ke route store Sub Kriteria --}}
    <form action="{{ route('admin.spk.manage.subkriteria.store', ['idKeputusan' => $keputusan->id_keputusan, 'idKriteria' => $kriteria->id_kriteria]) }}" method="POST">
        @csrf
