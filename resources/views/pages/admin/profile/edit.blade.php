                    ...
                    <section>
                        ...
                        <form method="POST" action="{{ route('admin.profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full px-2 py-2" :value="old('nama', $user->nama)" required autofocus autocomplete="name" />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full px-2 py-2" :value="old('email', $user->email)" required autocomplete="username" />
                            ...
                            <div>
                                ...
                                <x-text-input id="no_telpon" name="no_telpon" type="tel" class="mt-1 block w-full px-2 py-2" :value="old('no_telpon', $user->no_telpon)" />
