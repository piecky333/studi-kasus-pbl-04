                        ...
                        <label id="dropzone-label" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="text-sm text-gray-600">
                                    <span id="file-name" class="font-medium text-indigo-600">Upload file baru</span> <span id="drag-text">atau drag and drop</span>
                                </div>
...
<script>
    document.getElementById('gambar_berita').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            fileName.textContent = 'Upload file baru';
